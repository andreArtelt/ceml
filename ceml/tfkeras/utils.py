# -*- coding: utf-8 -*-
import numpy as np
from ..backend.tensorflow.layer import create_tensor
from ..backend.tensorflow.costfunctions import L1Cost, L2Cost, l1, l2, NegLogLikelihoodCost, DummyCost
...
def wrap_input(features_whitelist, x, model, optimizer):
    ...
    grad_based_solver = is_optimizer_grad_based(optimizer) if isinstance(optimizer, str) is True else True    # We assume that all tensorflow optimizers are gradient based optimizers
